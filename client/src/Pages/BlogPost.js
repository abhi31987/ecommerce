...
import './BlogPost.css'; // Import your custom styles for the BlogPost component
...
const BlogPost = () => {
  return (
    <div className="blog-container">
      ...
      <h2 className="blog-title">A Journey Through Time and Thread</h2>
      ...
      <h2 className="blog-title">Weaving Dreams, One Click at a Time</h2>
...
<h2 className="blog-title">An Intersection of Tradition and Technology</h2>
...
<h2 className="blog-title">A Virtual Showcase of Opulence</h2>
...
<h2 className="blog-title">Empowering Artisans and Elevating Craftsmanship</h2>
...
<h2 className="blog-title">Unveil Your Unique Expression</h2>
...
<h2 className="blog-title">Navigating the Digital Emporium</h2>
...
<h2 className="blog-title">A World of Possibilities, One Click Away</h2>
...
<p>
  ...
  <img className="blog-image" src={bg9} alt="Time and Thread" />
      ...
      <h2 className="blog-title">The Rich Tapestry of Tradition</h2>
      ...
      <h2 className="blog-title">A Kaleidoscope of Choices</h2>
      ...
      <h2 className="blog-title">The Art of Personalization</h2>
...
<h2 className="blog-title">Bridging Boundaries</h2>
...
<h2 className="blog-title">From Showroom to Virtual Showstopper</h2>
...
<h2 className="blog-title">Empowering Artisans</h2>
...
<h2 className="blog-title">A New Dawn for Tradition</h2>
